...
objeto no console.*/
import { Cliente } from "./P.O.O/src 19.09.22/atv1cliente";
...
import { Aviao } from "./P.O.O/src 19.09.22/atv2aviao";
...
informações deste objeto no console.*/
import { Funcionario } from "./Exercícios/P.O.O/src 19.09.22/atv4funcionario";
